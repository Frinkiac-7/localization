...
const useEnglish = function () {
  ...
  $('#main-view').attr('class', 'container body-en')
  $('#title-locale').text('English')
  $('#pagehead-locale').text('Simple Localization Demo')
  $('#pagehead-locale').attr('class', 'border-en')
  $('#main-locale').attr('class', 'body-en')
...
const useSpanish = function () {
  ...
  $('#pagehead-locale').attr('class', 'border-es')
  $('#main-locale').attr('class', 'body-es')
...
const useJapanese = function () {
  ...
  $('#pagehead-locale').attr('class', 'border-jp')
  $('#main-locale').attr('class', 'body-jp')
...
const useChinese = function () {
  ...
  $('#body-locale').attr('class', 'border-cn')
  $('#body-locale').text('')
}
